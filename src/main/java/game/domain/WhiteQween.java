 ...
 */
public class WhiteQween extends Figures {

    public WhiteQween() {
        url = this.getClass().getClassLoader().getResource("images/WhiteQween.png");

//        try {
//            url = new URL("file://" + "/E:/MYBUSY/Files/Idea/Project/Checkers/src/main/resources/images/WhiteQween" +
//                    ".png");
