 ...
 */
public class BlackHorse extends Figures {

    public BlackHorse() {

        url = this.getClass().getClassLoader().getResource("images/BlackHorse.png");

//        try {
//            url = new URL("file://" + "/E:/MYBUSY/Files/Idea/Project/Checkers/src/main/resources/images/BlackHorse" +
//                    ".png");
