 ...
 */
public class WhiteBishop extends Figures {

    public WhiteBishop() {

        url = this.getClass().getClassLoader().getResource("images/WhiteBishop.png");

//        try {
//            url = new URL("file://" + "/E:/MYBUSY/Files/Idea/Project/Checkers/src/main/resources/images/WhiteBishop" +
//                    ".png");
